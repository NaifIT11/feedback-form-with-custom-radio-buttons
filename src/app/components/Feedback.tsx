    ...
    <div className="w-3/4 main-shadow md:w-1/2 rounded-sm p-6 bg-white-200 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
      ...
      <form className="mt-4 flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        >
          {radioItemsValues.map((ri) => (
            ...
            >
              <div
                data-checked={selectedValue === ri.value}
                className="flex data-[checked=true]:border-blue-600 flex-col items-center gap-2 p-2 rounded bg-white border border-blue-300"
              >
                {ri.SVG}
                <div
                  role="heading"
        ...
        <div className="self-end">
          <button type="submit" className="px-4 py-2 rounded font-medium text-white bg-blue-900">
            Submit
          </button>
        </div>
      </form>
